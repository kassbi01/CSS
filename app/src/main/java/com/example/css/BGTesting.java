...
public class BGTesting extends AppCompatActivity {
    ...
    public class testGetUserData extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                Document doc = Jsoup.connect("http://inducesmile.com/").get(); //Doc contains HTML data from Jsoup
                Elements element = doc.select("a[href]"); // This tag will get us all post data
        ...
        public void saveData(String[] array, String arrayName, Context ctex) { //Method to save our array to SharedPreferences
...
//            }
        ...
        protected void onPostExecute(Void aVoid) { // the final steps to our Async Task
            ...
            adapter = new CustomCurationAdapter(BGTesting.this, listItem); //implement new adapter
